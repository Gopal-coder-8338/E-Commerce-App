...
import RelaventProduct from "../components/RelaventProduct";
      ...
      {/* Product Data */}
        ...
        <div className="mt-20">
          <div className="flex">
              ...
              <p className="border px-5 py-3 text-sm">Review (355)</p>
          </div>
        ...
        <RelaventProduct category={productData.category} subCategory={productData.subCategory} />
    </div>
